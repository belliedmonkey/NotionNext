...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Belliedmonkey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Belliedmonkey,LLC', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aragorn.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Transcription, video transcription, video to text ,Translator, Video Translator, Video Subtitle, Video Translation, Video Subtitle Translator, Video Subtitle Translation, Video Subtitle Translator, Video Subtitle Translation', // 网站关键词 英文逗号隔开
