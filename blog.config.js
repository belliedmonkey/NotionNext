...
const BLOG = {
  ...
  NOTION_PAGE_ID:process.env.NOTION_PAGE_ID || '1f4799b235b442aca5de1ab087c38894,en:1f4799b235b442aca5de1ab087c38894,zh:5d1648c1a3914a9099b02b6538e23396,jp:1badd82ac8ed426a908589b0ca51ca1d',
  ...
  GREETING_WORDS:
    ...
    'Aragorn is a one-stop video transcription and translation platform that helps you create and share video content in multiple languages.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aragorn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Aragorn is a one-stop video transcription and translation platform that helps you create and share video content in multiple languages.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.aragorn.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'translation, transcription', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aragorn@belliedmonkey.cc', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/belliedmonkey', // 你的twitter个人主页
  ...
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || 'blogs',
